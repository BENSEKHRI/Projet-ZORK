 ...
 * renvoyée sous forme d'une instance de la classe Commande.
 * </p>
 * <p>
 *
 * Cet analyseur contient un répertoire de toutes les commandes reconnues par le
 * jeu. Il compare les entrées de l'utilisateur au commandes répertoriées et si
 * la commande utilisateur n'est pas reconnue il renvoie un objet Commande
 * marqué comme étant une commande inconnue.
 * </p>
 *
